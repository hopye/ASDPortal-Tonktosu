Deno.serve(async (req) => {
    ...
    try {
        console.log('=== Process All Documents Function Started ===');
        ...
        // Get all documents for this user that don't have embeddings
        ...
        console.log('=== Process All Documents Function Completed ===');
        ...
        return new Response(JSON.stringify({
            data: {
                ...
                message: `Successfully processed ${processedCount} documents and created ${embeddingsCreated} embeddings`
            }
        }), {
        ...
        console.error('=== Process All Documents Function Error ===');
